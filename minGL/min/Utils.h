...
class Matrix;
#include "Matrix.h"
static const pfd PI = 3.14159265358979323846f;
...
void glhLookAtf1( Matrix *matrix, float *eyePosition3D,float *center3D, float *upVector3D );
void glhLookAtf2( Matrix *matrix, float *eyePosition3D,float *center3D, float *upVector3D );
